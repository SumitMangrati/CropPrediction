...
function SignIn2() {
  ...
  return (
    <div className="bg-white px-10 py-20 rounded-xl">
      <h1 className="text-5xl text-center font-bold text-green-700">Sign In</h1>
      <p>{loginToggle}</p>
      <div className="mt-8">
        <div>
        ...
        <div>
          <button className="bg-green-700 hover:bg-green-800 text-white font-bold py-2 px-4 rounded-full w-full ">Sign In</button>
          </div>
          <div className="mt-4 ">
            <p  onClick={()=>dispatch(toggleLogin())} 
            className=" text-blue-800 hover:underline text-blue-800">Don't have an account? Sign Up</p>
          </div>
   </div>
    </div>
  );
